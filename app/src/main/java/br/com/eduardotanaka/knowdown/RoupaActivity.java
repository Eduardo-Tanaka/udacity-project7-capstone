        ...
        mDatabase.child("users").child(user.getId()).addValueEventListener(
            new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    txtPontos.setText(String.valueOf(userDB.getCoin()));
    ...
    private  void carregarImagens(final int opcao){
        ...
        if(userDB.getGender() != "0"){
            if(opcao == 1) {
                ...
                txtRoupaOpcao1.setText(getResources().getString(R.string.price1));
                roupaId1 = 1;
                imgRoupaOpcao2.setImageResource(R.drawable.camisa_curta_rosa);
                txtRoupaOpcao2.setText(getResources().getString(R.string.price2));
                roupaId2 = 2;
                imgRoupaOpcao3.setImageResource(R.drawable.camisa_curta_verde);
                txtRoupaOpcao3.setText(getResources().getString(R.string.price3));
                roupaId3 = 3;
                imgRoupaOpcao4.setImageResource(R.drawable.camisa_curta_amarela);
                txtRoupaOpcao4.setText(getResources().getString(R.string.price4));
                roupaId4 = 4;
                imgRoupaOpcao5.setImageResource(R.drawable.camisa_curta_azul);
                txtRoupaOpcao5.setText(getResources().getString(R.string.price5));
                roupaId5 = 5;
                imgRoupaOpcao6.setImageResource(R.drawable.camisa_curta_vermelha);
                txtRoupaOpcao6.setText(getResources().getString(R.string.price6));
                roupaId6 = 6;
                tipo = 1;
            } else if(opcao == 2) {
